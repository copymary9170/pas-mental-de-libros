...
APP_VERSION = "Paz Mental deploy 2026-05-27 v14 - entrypoint correcto"
...
tab_timer, tab_search, tab_link, tab_calendar, tab_ao3, tab_books, tab_reports, tab_canons, tab_add, tab_chapters, tab_diag, tab_export = st.tabs([
    "⏱️ Cronómetro", "🔎 Buscar e importar", "🔗 Importar link", "📅 Calendario", "🔔 AO3", "📚 Biblioteca", "🏆 Wrapped / Reportes", "🌌 Canons", "➕ Agregar manual", "📝 Capitulos", "🧰 Diagnóstico", "⬇️ Exportar",
])
