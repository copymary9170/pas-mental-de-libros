# 🧠 Premios automaticos de experiencia
...
|---|---|---|---|
| La vi apenas se estreno |  | Fecha de inicio entre 0 y 7 dias despues del estreno/publicacion |  |
| La vi con poco tiempo de estrenarse |  | Fecha de inicio entre 8 y 45 dias despues del estreno/publicacion |  |
| Estreno reciente tardio |  | Fecha de inicio entre 46 y 90 dias despues del estreno/publicacion |  |
| Llegue tarde pero valio la pena |  | Mas de 90 dias entre estreno e inicio + nota alta/opinion positiva |  |
| Llegue tarde y no entendi el hype |  | Mas de 90 dias entre estreno e inicio + nota baja/opinion negativa |  |
| La termine en tiempo record |  | Pocos dias entre inicio y finalizacion segun cantidad de capitulos/paginas |  |
| Obra que debi terminar antes |  | Mucho tiempo entre inicio y finalizacion + opinion final positiva |  |

## Premios por maraton y ritmo

| Premio | Ganador | Como se calcula | Certeza |
|---|---|---|---|
| Maraton mas intenso |  | Mayor cantidad de capitulos/episodios vistos en un mismo dia |  |
| Maraton mas largo |  | Varios dias seguidos con muchos avances de la misma obra |  |
| Maraton mas espontaneo |  | Muchos capitulos/episodios el mismo dia que la empece |  |
| Maraton que no pude soltar |  | Muchos avances en pocos dias + opinion de enganche/adiccion |  |
| Maraton que me dejo destruido |  | Muchos avances en pocos dias + opinion emocional fuerte |  |
| Dia mas intenso del año |  | Dia con mas capitulos/episodios/paginas registrados entre todas las obras |  |
| Mes con mas actividad |  | Mes con mas avances o mas obras terminadas |  |
| Obra perfecta para maratonear |  | Ritmo rapido + opinion positiva |  |
| Obra perfecta para ver de a poco |  | Ritmo espaciado + opinion positiva sobre verla/leerla lento |  |

## Premios por bloqueo y regreso

| Premio | Ganador | Como se calcula | Certeza |
|---|---|---|---|
| Obra que me saco de un bloqueo general |  | Primera obra registrada despues de mucho tiempo sin actividad en ningun tipo |  |
| Obra que me saco de un bloqueo de series |  | Primera serie registrada despues de 30+ dias sin series |  |
| Obra que me saco de un bloqueo de libros |  | Primer libro registrado despues de 30+ dias sin libros |  |
| Obra que me saco de un bloqueo de peliculas |  | Primera pelicula registrada despues de 30+ dias sin peliculas |  |
| Obra que me saco de un bloqueo de anime |  | Primer anime registrado despues de 30+ dias sin anime |  |
| Obra que me saco de un bloqueo de manga |  | Primer manga registrado despues de 30+ dias sin manga |  |
| Obra que me saco de un bloqueo de manhwa |  | Primer manhwa registrado despues de 30+ dias sin manhwa |  |
| Obra que me saco de un bloqueo de comics |  | Primer comic registrado despues de 30+ dias sin comics |  |
| Obra que me saco de un bloqueo de fanfiction |  | Primera fanfiction registrada despues de 30+ dias sin fanfiction |  |
| Obra que me saco de un bloqueo de documentales |  | Primer documental registrado despues de 30+ dias sin documentales |  |
| Obra que me metio en un bloqueo general |  | Despues de terminarla o abandonarla paso mucho tiempo sin actividad general |  |
| Obra que me metio en un bloqueo por tipo |  | Despues de terminarla o abandonarla paso mucho tiempo sin consumir ese mismo tipo |  |
| Tipo que mas retome este año |  | Tipo con pausa larga y luego varios avances nuevos |  |
| Tipo que mas abandone este año |  | Tipo con mas pausas largas, abandonos o inactividad |  |

## Premios por pendientes, pausas y retomadas

| Premio | Ganador | Como se calcula | Certeza |
|---|---|---|---|
| Pendiente mas antiguo que por fin empece |  | Mayor distancia entre fecha agregada a pendientes y fecha de inicio |  |
| Pendiente mas antiguo que por fin termine |  | Mayor distancia entre fecha agregada a pendientes y fecha de finalizacion |  |
| Obra que retome despues de mucho tiempo |  | Pausa larga entre dos registros de avance |  |
| Retomada mas satisfactoria |  | Retomada + nota alta/opinion positiva |  |
| Retomada mas dificil |  | Retomada + pausas repetidas o comentarios de dificultad |  |
| Obra que abandone rapido |  | Abandonada con pocos capitulos/paginas o pocos dias desde inicio |  |
| Obra que casi abandono pero despues ame |  | Registros iniciales negativos + opinion final positiva |  |
| Obra que casi abandono pero salvo el final |  | Opinion negativa durante el avance + opinion positiva del final |  |

## Premios por reaccion personal inferida

| Premio | Ganador | Como se calcula | Certeza |
|---|---|---|---|
| Obra que me dio paz mental |  | Opinion con palabras como calma, paz, comfort, tranquila, bonita |  |
| Obra que me rompio la paz mental |  | Opinion con ansiedad, caos, trauma, sufrimiento, obsesion |  |
| Obra que se sintio como terapia |  | Opinion indica que ayudo, acompaño o llego cuando la necesitaba |  |
...
- Ganador probable: hay varias señales, pero falta confirmacion.
